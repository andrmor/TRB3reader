...
private:
    ...
    int                         _MultiplicityPos[3];    // Pad multiplicity - can be used independently for x y z
    int                         _MultiplicityNeg[3];    // same for negative

    float                       _SumSigPos[3];          // sum dignals - can be used independently for x y z
    float                       _SumSigNeg[3];          // sum signals - can be used independently for x y z
};
